...
filters = [
  # Apiwoods::Pipeline::NormalizeMentionFilter,
  # Apiwoods::Pipeline::EmbedVideoFilter,
  Apiwoods::Pipeline::MarkdownFilter,
  # Apiwoods::Pipeline::MentionFilter,
  # Apiwoods::Pipeline::FloorFilter,
  # Apiwoods::Pipeline::TwemojiFilter
]

DescriptionPipeline = HTML::Pipeline.new(filters, context)

module Apiwoods
  class Markdown
    class << self
      def call(body)
        result = DescriptionPipeline.call(body)[:output]
        result.strip!
        result
      end
